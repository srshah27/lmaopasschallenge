...
export default function Home() {
	...
	const dimLightsRef = useRef(null)
	...
	function dimLights(boolean) {
		if (boolean) {
			dimLightsRef.current.classList.add('shake')
		} else {
			dimLightsRef.current.classList.remove('shake')
		}
	}
		...
		<>
			<div className={styles.container}>
				<div className={styles.title}>
					<Image src="/quirkylock_purple.png" width={55} height={55} alt="" />
					<div className={styles.title_text}>LmaoPass Challenge</div>
				</div>
